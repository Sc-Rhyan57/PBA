...
setSpriteShader("dad", "colorInversion")
setShaderInt("dad", "invert", 2)
setShaderFloat('dad', 'binaryIntensity', math.random(-8,-5)/20)
...
if noteType == 'Glitch Note 2' and getProperty('dad.curCharacter') ~='finn-hurting' then
setSpriteShader("dad", "colorInversion")
setShaderInt("dad", "invert", 2)
setShaderFloat('dad', 'binaryIntensity', math.random(-8,-5)/20)
runTimer('resetColor',0.02)
...
setSpriteShader("Jake", "colorInversion")
setShaderInt("Jake", "invert", 2)
--setProperty('jake.color',getColorFromHex('ff0000'))
runTimer('resetColorJake',0.02)
setShaderFloat('Jake', 'binaryIntensity', math.random(-12,-6)/20)
end
...
setSpriteShader("dad", "colorInversion")
setShaderInt("dad", "invert", 0)
setShaderFloat('dad', 'binaryIntensity', 20.0)
end
...
setShaderFloat('Jake', 'binaryIntensity', 20.0)
end
end