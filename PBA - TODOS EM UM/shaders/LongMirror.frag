...
// ShaderToy version with constants, screen curvature effect, and edge cloning

uniform float x;       // Adjust these values as needed
uniform float y;
uniform float zoom;
uniform float angle;  // Angle in degrees
uniform float curvature; // Curvature factor (adjust to control distortion)
