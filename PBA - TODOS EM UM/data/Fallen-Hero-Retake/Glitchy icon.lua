...
normalY2 = getProperty('OPP.y') + 5

doTweenY('icondown2', 'OPP', normalY2, 0.15, 'linear')
initLuaShader("Glitchy")
setSpriteShader("OPP", "Glitchy")
setProperty('OPP.useFramePixels', true)

end

function onUpdate()
setShaderFloat("OPP", "iTime", os.clock())

if getProperty('health') < 1.63 then

if glitch then
setShaderFloat("OPP", "AMT", 0.1)
setShaderFloat("OPP", "SPEED", 0.1)
...
if glitch then
setShaderFloat("OPP", "AMT", 0.3)
setShaderFloat("OPP", "SPEED", 0.3)
...
zozo2 = false
doTweenY('iconup2', 'OPP', normalY2 - 10, 0.15, 'linear')


elseif getProperty('health') < 1.63 and zozo2 == false then
zozo2 = true
doTweenY('iconnor2', 'OPP', normalY2, 0.15, 'linear')
