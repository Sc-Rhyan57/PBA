function onCreate()
	--intro
	makeLuaSprite('img', 'cawm-pafanbuild/intro/img', 150, 300)
	scaleObject('img', 0.85, 0.85)
	setScrollFactor('img', 1, 1)
	addLuaSprite('img')

    makeLuaSprite('titulo3', 'cawm-pafanbuild/intro/Ilustracion_sin_titulo-3', 150, 300)
    scaleObject('titulo3', 0.85, 0.85)
    setScrollFactor('titulo3', 1, 1)
    addLuaSprite('titulo3', true)

	makeLuaSprite('titulo2', 'cawm-pafanbuild/intro/Ilustracion_sin_titulo-2', 250, 500)
	scaleObject('titulo2', 0.85, 0.85)
	setScrollFactor('titulo2', 1.2, 1.2)
	addLuaSprite('titulo2')

	makeLuaSprite('titulo2t', 'cawm-pafanbuild/intro/Ilustracion_sin_titulo-2t', 250, 500)
	scaleObject('titulo2t', 0.85, 0.85)
	setScrollFactor('titulo2t', 1.2, 1.2)
	addLuaSprite('titulo2t', true)

	makeLuaSprite('titulo1', 'cawm-pafanbuild/intro/Ilustracion_sin_titulo-1', 150, 300)
	scaleObject('titulo1', 0.85, 0.85)
	setScrollFactor('titulo1', 1, 1)
	addLuaSprite('titulo1')
---------------------------------------------------------------------------------
	
	makeLuaSprite('cs', 'cawm-pafanbuild/reveal/CameraShtuff', 0, 0)
	scaleObject('cs', 1, 1)
...
----------------------------------------------------------------------------------
   --reveal
   	makeLuaSprite('glitch', 'cawm-pafanbuild/reveal/glitch', 150, 600)
	scaleObject('glitch', 0.85, 0.85)
	setScrollFactor('glitch', 1, 1)
	addLuaSprite('glitch')
 
    makeLuaSprite('hstf', 'cawm-pafanbuild/reveal/HillStuff', 150, 600)
	scaleObject('hstf', 0.85, 0.85)
	setScrollFactor('hstf', 1, 1)
	addLuaSprite('hstf')

	makeLuaSprite('dangling', 'cawm-pafanbuild/reveal/Dangling', 250, 700)
	scaleObject('dangling', 0.85, 0.85)
	setScrollFactor('dangling', 1.2, 1.2)
	addLuaSprite('dangling')

	makeLuaSprite('aboveglitch', 'cawm-pafanbuild/reveal/AboveGlitch', 150, 600)
	scaleObject('aboveglitch', 0.85, 0.85)
	setScrollFactor('aboveglitch', 1, 1)
	addLuaSprite('aboveglitch')

	makeLuaSprite('particles', 'cawm-pafanbuild/reveal/Particles', 150, 600)
	scaleObject('particles', 0.85, 0.85)
	setScrollFactor('particles', 1, 1)
	addLuaSprite('particles', true)

	makeLuaSprite('corruption', 'cawm-pafanbuild/reveal/Corruption', 150, 600)
	...
	makeAnimatedLuaSprite('lighting', 'cawm-pafanbuild/Lighting', 1050, 150);
...
----------------------------------------------------------------------------------
   	...
   	makeLuaSprite('back', 'cawm-pafanbuild/back', -200, -50)
	scaleObject('back', 1, 1)
	setScrollFactor('back', 0.6, 0.6)
	addLuaSprite('back')

	makeLuaSprite('tree', 'cawm-pafanbuild/tree', 0, 200)
...
function onUpdate()
	...
	if curStep >= 896 then
     ...
     if curStep >= 1152 then
            ...
            doTweenY('ermBF', 'boyfriend', 1650, 0.001, 'linear')
