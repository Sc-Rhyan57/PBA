...
setPropertyFromGroup('unspawnNotes', i, 'texture', 'mechanics/Bullet_Note'); --Change texture
...
dodgeAnimations = {
    'shootLEFT', 'shootDOWN', 'shootUP', 'shootRIGHT'
}
hurtAnimations = {
...
characterPlayAnim('dad', hurtAnimations[noteData+1], true);
